 ...
 *
 * In this case you use flatMapConcat { } to flatten it to receive Flow<String>. It waits for inner
 * flow to complete before starting to collect the next one. Here getDetails() is the inner Flow.
 */
@FlowPreview
